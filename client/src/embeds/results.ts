import type { ButtonInteraction, EmbedField, InteractionResponse } from 'discord.js'
...
export default function (response: InteractionResponse, tournament: Tournament) {
  let page = 1
